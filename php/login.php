...
<script>
  function courses(){
      window.open("http://localhost/courses.php");
  }
</script>
        <title>QUESER</title>
        <meta charset="UTF-8" />
...
.e1_76 { 
  ...
  left:1250px;
    ...
    .input1{padding:8px;font-size:12px;color:blue;width:40%}
        </style>
</head>
...
<body>
<img src="ublogo.jpg"width="85" length="85"/ alt="My logo">
        <ul>
...
<form method="Post"Action="login.php" style="border:2px solid black;border-radius:6px;width:50%;background-color:rgb(238, 230, 230);padding:20px; "><br><br>
<p><label><b>Matricule No.</b>
<input class="input1" name="Matricule" type="text" size="25" maxlenght="20"/></p>
</label></p>
<p><label><b>Password</b>
<input class="input1" name="Password" type="password" size="25" maxlenght="35"/></p>
</label></p>
<p>
<button class="input2" name="Login" type="submit" style="text-decoration:none" onclick="courses()"><a href="">Login</a></button>
<input class="input2" type="reset" value="cancle"/>
</p>
</form>
<br>
<a href="reset password.html"><b> I have forgoten my password</b></a>
<br><br>
<a href="signup.php"><b>Create a new Account</b></a>
</br></br>
</br>
</center>
